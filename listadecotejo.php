...
$nombre = $_POST['lista'];
require 'con_db.php';
$consulta2= 'SELECT * FROM alumnoempresa where nombre_alumno ="'.$nombre.'"';
$consulta3= 'SELECT * FROM asignacion where nombre_alumno ="'.$nombre.'"';
  $resultado2 = $mysqli->query($consulta2);
  $resultado3 = $mysqli->query($consulta3);
while ($row2 = $resultado2->fetch_assoc() AND $row3 = $resultado3->fetch_assoc()) {
$pdf = new PDF();
$pdf->AliasNbPages();
$pdf->AddPage();
$pdf->SetFont('Helvetica','',12);
$pdf->Cell(70, 10, "Nombre del Alumno: ".$nombre,0 ,1,'L', 0);
...
<body class="grid-container">
 ...
 <main class="main">
                  <form class="registro" target="_blank" method="post">
